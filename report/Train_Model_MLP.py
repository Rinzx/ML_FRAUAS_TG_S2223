...
models = [
    ...
    MLPClassifier(alpha=0.00001, solver='sgd', hidden_layer_sizes= (100,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='adam', hidden_layer_sizes= (100,), learning_rate='adaptive', max_iter=1000),
    MLPClassifier(alpha=0.00001, solver='sgd', hidden_layer_sizes= (200,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='adam', hidden_layer_sizes= (200,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='sgd', hidden_layer_sizes= (300,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='adam', hidden_layer_sizes= (300,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='sgd', hidden_layer_sizes= (500,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='adam', hidden_layer_sizes= (500,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='sgd', hidden_layer_sizes= (1500,), learning_rate='adaptive', max_iter=1500),
    MLPClassifier(alpha=0.00001, solver='adam', hidden_layer_sizes= (1500,), learning_rate='adaptive', max_iter=1500) 
...
for model in models:
    ...
    # Generate ROC curves and calculate AUC scores (MLP Classifier)
